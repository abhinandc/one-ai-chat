	...
	theme: {
		...
		extend: {
			fontFamily: {
				...
				text: ['SF Pro Display', '-apple-system', 'BlinkMacSystemFont', 'system-ui', 'sans-serif']
			},
			colors: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { boxShadow: '0 0 20px hsla(var(--accent-blue), 0.3)' },
					'50%': { boxShadow: '0 0 40px hsla(var(--accent-blue), 0.6), 0 0 60px hsla(var(--accent-blue), 0.3)' }
				},
				'trail': {
					'0%': { '--angle': '0deg' },
					'100%': { '--angle': '360deg' }
